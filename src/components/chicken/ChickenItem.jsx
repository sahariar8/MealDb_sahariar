    ...
    return (
        <div>
            ...
            <div className="bg-white border border-gray-200 shadow dark:bg-gray-800 dark:border-gray-700">
               <div>
                    <a href="#">
                        <img className="h-100" src={strMealThumb} alt="" />
                    </a>
               </div>
                <div className="p-2">
                    <a href="#">
                    ...
                    <div className="flex justify-between ">
                        <Link to={`/Chicken/${idMeal}`}><button className="btn btn-primary text-white">Show Details</button></Link>
